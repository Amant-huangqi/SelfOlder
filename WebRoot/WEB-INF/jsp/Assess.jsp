	...
	<div class="main-container " id="main-container ">
		...
		<div id="sidebar" class="sidebar   responsive"
			...
			<ul class="nav nav-list">
				...
				<li class=""><a href="Menu.html?username=${username}">
				...
				<li class="active"><a href="#" class="dropdown-toggle"> <i
					...
					<ul class="submenu">
						<li class="active"><a href="Assess.html?username=${username}">
							...
							<div class="col-lg-6" style="width:200px">
								<div class="input-group">
									<span class="input-group-btn">
										<button class="btn btn-default" type="button" style="height:34px">分类</button>
...
<![endif]-->
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$("#select-spinnera").val("家常菜");
			getData("家常菜");
		});
		function changeData() {
			var sort = document.getElementById("select-spinnera").value;
			getData(sort);
		}
