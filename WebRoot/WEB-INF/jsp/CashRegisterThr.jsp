...
<body class="skin-1">
	...
	<div class="main-container " id="main-container ">
		...
		<div id="sidebar" class="sidebar   responsive"
			...
			<ul class="nav nav-list">
				...
				<li class="active"><a href="#" class="dropdown-toggle"> <i
					...
					<ul class="submenu">
						<li class=""><a href="CashRegister.html?username=${username}">
								<i class="menu-icon fa fa-caret-right"></i>未支付
						</a> <b class="arrow"></b></li>
						<li class=""><a
							href="CashRegisterTwo.html?username=${username}"> <i
								class="menu-icon fa fa-caret-right"></i>已支付
						</a> <b class="arrow"></b></li>
						<li class="active"><a
							href="CashRegisterThr.html?username=${username}"> <i
		...
		<div class="main-content">
			...
			<div class="page-content">
				...
				<div
					style="width:250px;height:300px;float:left;margin-left:50px;margin-top:30px;">
					<div class="input-group input-group-lg">
						<span class="input-group-addon">桌号</span> <input type="text"
							class="form-control" id="getTableNumber">
					</div>
					<div style="margin-top:80px;">
						<button type="button" class="btn btn-primary" style="float:left"
							onclick="sendZhangDan()">查看账单信息</button>
						<!-- 表示一个成功的或积极的动作 -->
						<button type="button" class="btn btn-success" style="float:right">打印发票</button>
					</div>
				</div>
				<div id="changeDiv"
					style="width:650px;float:left;margin-left:150px;overflow:auto;z-index:5;max-height:500px;display:none;">
	...
	<!-- /.main-content -->
	<script type="text/javascript">
		function sendZhangDan() {
			$("#changeDiv").show();
			var a = $("#getTableNumber").val();
			$("#changeDiv").load("getPayData.html?tablenumber=" + a);
		}
		...
		function gettime() {
			...
			var shows = "结算时间:" + year + "-" + month + "-" + day + " " + h
					+ ":" + mins + ":" + s;
			document.getElementById("time").innerHTML = shows;
		}
		function jisuan(tablenumber, total) {

			var zongjine = document.getElementById("zongjine").innerHTML;
			document.getElementById("zhaoling").value = "";
			var value = document.getElementById("shoukuan").value;
			if (value * 1 <= 0) {
				alert("输入有误");
				return;
			}
			var zhaoling = value * 1 - zongjine * 1;
			if (zhaoling < 0) {
				alert("输入有误");
				return;
			}
			document.getElementById("zhaoling").value = zhaoling;
			gettime();
			document.getElementById("shoukuanqueren").style.display = "none";
			$("#tda" + tablenumber).html("已支付");
			$("#tdb" + tablenumber).html("现金支付");
			$("#btn" + tablenumber).removeClass("btn-yellow");
